...
async function test() {
    // for at køre denne med debug skal man starte med "ts-node -r dotenv/config ./src/facades/user.ts" for at importere DEBUG env variablen som ellers kommer ind fra app.js
    console.log("testing")
